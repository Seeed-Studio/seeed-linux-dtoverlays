...
static void comp_for_grvty(uint16_t lsb_per_g, const int32_t g_val[3], const struct bma4_accel *data,
		struct offset_delta *comp_data)
{
	/*int64_t*/int32_t accel_value_lsb[3] = {0};
	uint8_t index;

	for (index = 0; index < 3; index++) {
		/* convert g to lsb */
		accel_value_lsb[index] = ((/*int64_t*/int32_t)(lsb_per_g) * (/*int64_t*/int32_t)(g_val[index]));
	}

	/*  Dividing the accel value in LSB by 1000000 to get
	compensated data back in g-value */
	comp_data->x.val = (int16_t)(data->x - (int16_t)((accel_value_lsb[BMA4_X_AXIS] / (/*int64_t*/int32_t)BMA4XY_MULTIPLIER)));
	comp_data->y.val = (int16_t)(data->y - (int16_t)((accel_value_lsb[BMA4_Y_AXIS] / (/*int64_t*/int32_t)BMA4XY_MULTIPLIER)));
	comp_data->z.val = (int16_t)(data->z - (int16_t)((accel_value_lsb[BMA4_Z_AXIS] / (/*int64_t*/int32_t)BMA4XY_MULTIPLIER)));
