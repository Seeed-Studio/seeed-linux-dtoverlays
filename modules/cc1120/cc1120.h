/* Copyright (c) 2021 SEEED Co.,Ltd. All Rights Reserved.
 *
 */
#ifndef _CC1120_H
#define _CC1120_H
...
#define CC112X_FIFO_ACCESS              0x3F      /*  FIFO ACCESS  - ACCESS TX/RX FIFO */
...
#define CC1120_FCS_LEN				(2)
#define CC1120_FCS_CRC_OK			BIT(7)
#define CC1120_FCS_LQI_MASK			(0x7F)

/* TX/RX_OFF_MODE */
#define  RXOFF_MODE     0x30
#define  TXOFF_MODE     0x30

/* ToDo: supporting 802.15.4g will make this header of a different size */
#define CC1120_PHY_HDR_LEN			(1)

struct cc1120_reg_s {
    uint8_t addr;               /*! base register addr */
    bool    extended;
    bool    command_strobes;
    bool    direct_memory;
    bool    fifo;
    ...
    uint8_t dflt;               /*! register default value */
};
...
typedef struct
{
	uint32_t chan_center_freq0; /* unit : KHz*/
	uint16_t channel_spacing;   /* spacing is a multiple of 100 Hz, like: 12.5KHz for instance will be 125. */
	cc1120_reg_settings_t   *p_rf_settings;
} cc1200_rf_registers_set_t;
