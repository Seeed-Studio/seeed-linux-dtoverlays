...
static int ili9881d_prepare(struct drm_panel *panel)
{
	...
	IILI9881_COMMAND(0xA0, 0x00);
	IILI9881_COMMAND(0xA1, 0x26);
	IILI9881_COMMAND(0xA2, 0x35);
	IILI9881_COMMAND(0xA3, 0x16);
	IILI9881_COMMAND(0xA4, 0x19);
	IILI9881_COMMAND(0xA5, 0x2C);
	IILI9881_COMMAND(0xA6, 0x1F);
	IILI9881_COMMAND(0xA7, 0x1F);
	IILI9881_COMMAND(0xA8, 0x96);
	IILI9881_COMMAND(0xA9, 0x1C);
	IILI9881_COMMAND(0xAA, 0x28);
	IILI9881_COMMAND(0xAB, 0x80);
	IILI9881_COMMAND(0xAC, 0x1A);
	IILI9881_COMMAND(0xAD, 0x18);
	IILI9881_COMMAND(0xAE, 0x4C);
	IILI9881_COMMAND(0xAF, 0x21);
	IILI9881_COMMAND(0xB0, 0x27);
	IILI9881_COMMAND(0xB1, 0x55);
	IILI9881_COMMAND(0xB2, 0x65);
	IILI9881_COMMAND(0xB3, 0x39);

	IILI9881_COMMAND(0xC0, 0x00);
	IILI9881_COMMAND(0xC1, 0x26);
	IILI9881_COMMAND(0xC2, 0x35);
	IILI9881_COMMAND(0xC3, 0x16);
	IILI9881_COMMAND(0xC4, 0x19);
	IILI9881_COMMAND(0xC5, 0x2C);
	IILI9881_COMMAND(0xC6, 0x1F);
	IILI9881_COMMAND(0xC7, 0x1F);
	IILI9881_COMMAND(0xC8, 0x96);
	IILI9881_COMMAND(0xC9, 0x1C);
	IILI9881_COMMAND(0xCA, 0x28);
	IILI9881_COMMAND(0xCB, 0x80);
	IILI9881_COMMAND(0xCC, 0x1A);
	IILI9881_COMMAND(0xCD, 0x18);
	IILI9881_COMMAND(0xCE, 0x4C);
	IILI9881_COMMAND(0xCF, 0x21);
	IILI9881_COMMAND(0xD0, 0x27);
	IILI9881_COMMAND(0xD1, 0x55);
	IILI9881_COMMAND(0xD2, 0x65);
	IILI9881_COMMAND(0xD3, 0x39);
