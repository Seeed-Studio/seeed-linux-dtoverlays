...
//	ST7701_DSI(st7701, 0x11);
	...
	ST7701_DSI(st7701, 0xC1, 0x0A,0x02);
	ST7701_DSI(st7701, 0xC2, 0x01,0x06);
	ST7701_DSI(st7701, 0xCC, 0x10);
	ST7701_DSI(st7701, 0xB0, 0x00,0x12,0x1A,0x0D,0x11,0x07,0x0C,0x0A,0x09,0x26,0x05,0x11,0x10,0x2B,0x33,0x1B);
	ST7701_DSI(st7701, 0xB1, 0x00,0x12,0x1A,0x0D,0x11,0x06,0x0B,0x07,0x08,0x26,0x03,0x11,0x0F,0x2B,0x33,0x1B);
	ST7701_DSI(st7701, 0xFF, 0x77,0x01,0x00,0x00,0x11);
	ST7701_DSI(st7701, 0xB0, 0x4D);
	ST7701_DSI(st7701, 0xB1, 0x2C);
	ST7701_DSI(st7701, 0xB2, 0x87);
	ST7701_DSI(st7701, 0xB3, 0x80);
	ST7701_DSI(st7701, 0xB5, 0x40);
	ST7701_DSI(st7701, 0xB7, 0x85);
	ST7701_DSI(st7701, 0xB8, 0x21);
	ST7701_DSI(st7701, 0xB9, 0x10);
	ST7701_DSI(st7701, 0xC0, 0x03);
...
static int st7701_dsi_probe(struct mipi_dsi_device *dsi)
{
	...
	desc = &ts8550b_desc;//of_device_get_match_data(&dsi->dev);
...
#else
	drm_panel_init(&st7701->panel, &i2c_md->i2c->dev, &st7701_funcs,
		       DRM_MODE_CONNECTOR_DSI);
#endif
